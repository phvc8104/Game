...
public class Pistol : MonoBehaviour
{
    ...
    public int maxAmmoInMag;       // Maximum ammo capacity in the magazine
    ...
    void Update()
    {
        ...
        bulletCountText.text = "Đạn: " + maxAmmoInMag.ToString();
    }
    public void UpdateBulletCountText()
    {
        if (bulletCountText != null)
        {
            bulletCountText.text = "Đạn: " + maxAmmoInMag.ToString(); // Cập nhật nội dung của Text với số đạn hiện tại
        }
    }
    void Shoot()
    {
